...
const startMessage = `Hi I Magnet 2 Gdrive Bot\nUpload Magnet Link To Gdrive And\n Get Public Link And Gdrive Link\n click /help For How To Use`;
...
bot.onText(/\/help/, async msg => {
  ...
  bot.on("message", async msg => {
    ...
    try {
      ...
      const publicLink = `${process.env.SITE}/downloads/${fileName}?id=${driveId}`;
