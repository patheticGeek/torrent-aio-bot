...
const startMessage = `Heyya, I am a BOT Client of [Cloud Torrenter](https://cloudtorrenter.herokuapp.com)

I can *Download files through Magnetic Links and Upload to Telegram. You can also view the Files on our *Team Drive*`;
const helpMessage = `Welcome, here are some commands to get you started:
...
bot.onText(/\/start/, function onStart(msg) {
  ...
  bot.sendMessage(msg.from.id, startMessage, opts);
});
