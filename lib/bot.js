    ...
    reply_markup:{
      inline_keyboard: [
        ...
        [
          {
            text: 'Report Bugs',
            url: 'https://t.me/EverythingSuckz'
          }
        ]
      ]
    },
...
bot.on('callback_query', async callbackQuery => {
  ...
  if (action === 'grouplink') {
    text = 'https://groups.google.com/g/cloudtorrenter';
  }
  bot.sendChatAction(chat_id, typing)
  bot.sendMessageText(text, opts);
});
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bot.on('callback_query', async callbackQuery => {
  const action = callbackQuery.data;
...
bot.on('callback_query', async callbackQuery => {
  ...
  if (action === 'advancedhelp') {
    text = 'https://telegra.ph/Advanced-Help-for-Cloud-Torrenter-07-31';
  }
  bot.sendChatAction(chat_id, typing)
  bot.sendMessageText(text, opts);
});
